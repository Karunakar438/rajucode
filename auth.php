		...
		else
		{
			...
			if($this->ion_auth->is_admin()){
			   ...
			   $this->template->write_view('sidebar', 'default/sidebar');
					...
					// $this->data['count']=$this->Common_model->get_data_by_query("SELECT COUNT(*) FROM ipd_admit a left join patient p on a.admit_uhid=p.id 	where admit_status ='DISCHARGED'");
			...
			elseif($this->ion_auth->in_group('mpboc')){
				
				//print_r($this->data['users']);
				//die;
				redirect('admin/MPBOC0010', $this->data['users']);
				
			}
			elseif($this->ion_auth->in_group('csma')){
				
				//print_r($this->data['users']);
				//die;
				
				redirect('admin/CSMA0009', $this->data['users']);
			...
			elseif($this->ion_auth->in_group('cghs')){
				...
				//print_r($this->data['users']);
				//die;CGHS0007/cghsDashboard/
				redirect('admin/CGHS0007/cghsDashboard', $this->data['users']);
				
			}
			elseif($this->ion_auth->in_group('echs')){
				
				//print_r($this->data['users']);
				//die;
				redirect('admin/ECHS0011', $this->data['users']);
				
			}
			elseif($this->ion_auth->in_group('esi')){
				
				//print_r($this->data['users']);
				//die;
				redirect('admin/ESI0012', $this->data['users']);
			...
			elseif($this->ion_auth->in_group('MR')){
				
				//print_r($this->data['users']);
				//die;
				redirect('admin/MR00024/newDemands/', $this->data['users']);
				
			}
			elseif($this->ion_auth->in_group('stockest')){
				
				//print_r($this->data['users']);
				//die;
				redirect('admin/STOCKEST00027/newDemands/', $this->data['users']);
				
			}
			elseif($this->ion_auth->in_group('medicenStock')){
				
				//print_r($this->data['users']);
				//die;
				redirect('admin/MSTOCK00023/seeDemand/', $this->data['users']);
			...
			elseif($this->ion_auth->in_group('patientreg')){
			...
			//	redirect('admin/dashbord', $this->data['users']);
			redirect('admin/BILL00018/dashbord', $this->data['users']);
			...
			elseif($this->ion_auth->in_group('pharma')){
				...
				//redirect('admin/PHY00022/mediReq', $this->data['users']);
				redirect('admin/PHY00022/dashboard', $this->data['users']);
